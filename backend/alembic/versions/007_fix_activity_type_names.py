"""backfill imperial activity type names to metric in activities table

Revision ID: 007
Revises: 006
Create Date: 2026-06-20

Migration 003 renamed conversion_rules + activities at the time it ran, but
Garmin-imported activities added after that point used the old imperial names
from the un-fixed GARMIN_TYPE_MAP. This migration re-applies the same renames
to catch all stragglers.
"""
